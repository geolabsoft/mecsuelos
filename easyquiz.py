...
class Quiz():
    ...
    def __init__(self, title=None, description=None,  lang='esp',
                 load_json=False):
        ...
        Args:
            ...
            lang (str, optional): Quiz language. Defaults to 'esp'.
        ...
        if lang == 'esp':
            ...
            self.correct_msg = '¡Respuesta correcta!'
            self.wrong_msg = 'Ooops, parece que no lo has entendido bien.' + \
                '¡Vuelve a intentarlo!'
            self.intro = 'Pregunta'
        elif lang == 'eng':
            button_text = 'Check'
            self.correct_msg = 'Well done! Correct answer.'
            self.wrong_msg = 'Ooops, looks like something went wrong.' + \
                'Think it again!'
            self.intro = 'Questions'
        else:
            raise KeyError('Language "{}" not supported yet'.format(lang))
